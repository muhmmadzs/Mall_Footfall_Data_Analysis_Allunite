...
Repository & \url{https://github.com/muhmmadzs/Mall_Footfall_Data_Analysis_Allunite} \\
\bottomrule
\end{tabular}
\vfill
...
\begin{itemize}
  ...
  \item The Plan C weekly facility-hour footfall estimate is approximately 707,210. This is not the same as deduplicated mall visitors: facility-hour footfall can count the same person at multiple sensors, while mall-level visitors require cross-sensor deduplication. Plan B provides an additional mall-level deduplicated visitor estimate.
...
Repository:
\[
\text{\url{https://github.com/muhmmadzs/Mall_Footfall_Data_Analysis_Allunite}}
\]
